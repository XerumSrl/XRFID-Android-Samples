...
namespace XRFID.Sample.Webservice.Migrations
{
    ...
    [Migration("20230830145542_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.LoadingUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.LoadingUnitItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.Movement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.MovementItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.Reader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.LoadingUnitItem", b =>
                {
                    b.HasOne("XRFID.Sample.Webservice.Entities.LoadingUnit", "LoadingUnit")
            ...
            modelBuilder.Entity("XRFID.Sample.Webservice.Entities.MovementItem", b =>
                {
                    b.HasOne("XRFID.Sample.Webservice.Entities.LoadingUnitItem", "LoadingUnitItem")
                        .WithMany()
                        .HasForeignKey("LoadingUnitItemId");

                    b.HasOne("XRFID.Sample.Webservice.Entities.Movement", "Movement")
                        .WithMany("MovementItems")
                        .HasForeignKey("MovementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XRFID.Sample.Webservice.Entities.Product", "Product")
                        .WithMany()
